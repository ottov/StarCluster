...
HIMEM_TYPES = ['r3.large', 'r3.xlarge', 'r3.2xlarge', 'r3.4xlarge',
               'r3.8xlarge', 'x1.16xlarge', 'x1.32xlarge',
...
HI_STORAGE_TYPES = ['hs1.8xlarge', 'h1.2xlarge', 'h1.4xlarge']
...
HVM_TYPES = (HVM_ONLY_TYPES + HI_IO_TYPES + HI_STORAGE_TYPES + SEC_GEN_TYPES +
             M3_COMPUTE_TYPES + HIMEM_TYPES)

EBS_ONLY_TYPES = T1_INSTANCE_TYPES + T2_INSTANCE_TYPES + HIMEM_TYPES
